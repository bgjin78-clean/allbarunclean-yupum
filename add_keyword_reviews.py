...
# 1차: 유품정리(강남·송파·용산·용인·고양) + 고인집정리(서초·마포·수원·성남·화성)
# 2차: 고인집정리(강남·송파·용산·용인·고양·남양주) + 유품정리(서초·마포·성남·남양주)
EXTRA_REVIEWS = [
    {
        "region_type": "서울",
        "name": "강남구",
    ...
    # --- 2차 추가 10건 ---
    {
        ...
        "name": "강남구",
        "slug": "gangnam",
        "path": "gangnam/goinjip",
        "tag": "고인집정리",
        "place": "오피스텔",
        "title": "강남구 오피스텔 고인집정리 작업후기",
        "summary": "강남구 오피스텔에서 고인이 살던 공간의 살림을 비우고 원상 복귀에 가깝게 정리한 고인집정리입니다.",
        "keywords": "강남구 고인집정리, 강남구 오피스텔 고인집정리, 서울 고인집정리 작업후기",
        "details": [
            "강남구 역삼·선릉 인근 오피스텔 고인집정리 현장이었습니다. 단지형 오피스텔이라 관리실 협의와 화물 엘리베이터 사용 시간을 먼저 맞춘 뒤 작업을 시작했습니다.",
            "유품만 골라내는 수준이 아니라 침대, 책상, 가전, 주방 살림까지 비워야 하는 고인집정리였습니다. 가족분이 남기실 서류와 전자기기는 별도 상자에 담아 전달했습니다.",
            "좁은 복도 동선을 고려해 큰 가구부터 분해 후 반출했고, 마무리 전 바닥과 싱크대 주변까지 정리 상태를 함께 확인했습니다. 강남구 고인집정리는 단지 규정에 맞춘 시간 관리가 핵심이었습니다.",
        ],
    },
    {
        "region_type": "서울",
        ...
        "tag": "고인집정리",
        "place": "아파트",
        "title": "송파구 아파트 고인집정리 작업후기",
        "summary": "송파구 아파트에서 고인의 살림살이와 가구를 정리해 집을 비운 고인집정리 작업후기입니다.",
        "keywords": "송파구 고인집정리, 송파구 아파트 고인집정리, 서울 고인집정리 작업후기",
        "details": [
            "송파구 잠실권 아파트 고인집정리 상담이었습니다. 대단지라 차량 진입과 폐기물 임시 적치 위치를 관리사무소에 미리 확인한 뒤 작업을 잡았습니다.",
            "안방 옷장과 거실 가구, 주방 살림 순으로 고인집정리를 진행했습니다. 가족분이 확인이 필요하다고 하신 상자류는 현관 쪽에 모아 두었고, 나머지는 반출 목록에 올렸습니다.",
            "베란다와 창고 물품까지 포함해 공간을 비웠고, 작업 후 각 방 상태를 함께 점검했습니다. 송파구 고인집정리는 물품 양보다 반출 동선을 짧게 잡는 것이 작업 시간을 좌우했습니다.",
        ],
    },
    {
        "region_type": "서울",
        "name": "용산구",
        "slug": "yongsan",
        "path": "yongsan/goinjip",
        "tag": "고인집정리",
        "place": "주택",
        "title": "용산구 주택 고인집정리 작업후기",
        "summary": "용산구 주택에서 고인이 살던 집 전체를 비우고 살림을 정리한 고인집정리 현장입니다.",
        "keywords": "용산구 고인집정리, 용산구 주택 고인집정리, 서울 고인집정리 작업후기",
        "details": [
            "용산구 후암·청파 인근 주택 고인집정리 현장이었습니다. 골목 주차와 계단 반출이 어려워 작업 인원과 운반 순서를 먼저 나눴습니다.",
            "1층 거실 가구부터 2층 방의 옷장·서류까지 층별로 고인집정리를 진행했습니다. 가족분이 남기고 싶은 사진과 유품은 별도로 포장해 전달했습니다.",
            "큰 장롱은 현장에서 분해한 뒤 계단으로 내렸고, 마당과 다용도실 잡동사니까지 함께 치웠습니다. 용산구 고인집정리는 건물 구조에 맞춘 동선 계획이 작업의 핵심이었습니다.",
        ],
    },
    {
        "region_type": "경기",
        ...
        "tag": "고인집정리",
        "place": "아파트",
        "title": "용인시 아파트 고인집정리 작업후기",
        "summary": "용인시 아파트에서 고인의 가구·가전과 생활물품을 정리해 집을 비운 고인집정리입니다.",
        "keywords": "용인시 고인집정리, 용인시 아파트 고인집정리, 경기 고인집정리 작업후기",
        "details": [
            "용인시 수지구 아파트 고인집정리 현장이었습니다. 시 면적이 넓어 상담 시 정확한 동·호수와 지하 주차장 진입 가능 여부를 먼저 확인했습니다.",
            "거실과 안방, 작은방, 주방 순으로 살림을 걷어내는 고인집정리를 진행했습니다. 멀리 계신 가족분께 남길 물건 목록을 미리 받아 현장에서 그대로 맞춰 분류했습니다.",
            "폐기물은 단지 내 지정 위치로 옮긴 뒤 차량에 실었고, 작업 후 빈 공간을 함께 확인했습니다. 용인시 고인집정리는 단지 규정과 주차 환경을 맞추는 사전 확인이 특히 중요했습니다.",
        ],
    },
    {
        "region_type": "경기",
        ...
        "tag": "고인집정리",
        "place": "빌라",
        "title": "고양시 빌라 고인집정리 작업후기",
        "summary": "고양시 빌라에서 고인이 사용하던 살림살이를 정리하고 공간을 비운 고인집정리 작업후기입니다.",
        "keywords": "고양시 고인집정리, 고양시 빌라 고인집정리, 경기 고인집정리 작업후기",
        "details": [
            "고양시 덕양구 빌라 고인집정리 상담이었습니다. 엘리베이터 없는 구조라 계단 반출과 골목 주차부터 계획을 세웠습니다.",
            "거실 가구와 방의 옷장, 주방 가전 순으로 고인집정리를 진행했습니다. 가족분이 남기실 앨범과 서류는 별도 상자에 담아 바로 전달했습니다.",
            "큰 가구는 분해 후 반출했고, 베란다에 쌓인 생활용품까지 함께 정리했습니다. 고양시 고인집정리는 빌라형 현장에서 반출 동선을 얼마나 짧게 잡느냐가 작업 속도를 결정했습니다.",
        ],
    },
    {
        "region_type": "경기",
        "name": "남양주시",
        "slug": "namyangju",
        "path": "namyangju/goinjip",
        "tag": "고인집정리",
        "place": "아파트",
        "title": "남양주시 아파트 고인집정리 작업후기",
        "summary": "남양주시 아파트에서 고인 집의 살림을 비우고 공간을 정돈한 고인집정리 작업후기입니다.",
        "keywords": "남양주시 고인집정리, 남양주시 아파트 고인집정리, 경기 고인집정리 작업후기",
        "details": [
            "남양주시 다산·별내 권역 아파트 고인집정리 현장이었습니다. 서울 동북권과 이어지는 생활권이라 단지 규정과 반출 가능 시간을 관리실에 먼저 확인했습니다.",
            "서류와 사진 분류 후 옷장·주방·베란다 순으로 살림을 걷어내는 고인집정리를 진행했습니다. 가족분이 확인이 필요하다고 하신 상자만 남기고 나머지는 반출했습니다.",
            "대형 가구는 화물 엘리베이터로 내렸고, 남은 생활폐기물은 분류해 반출했습니다. 남양주시 고인집정리는 보관품 확인과 집 비우기를 같은 일정에 맞추는 것이 핵심이었습니다.",
        ],
    },
    {
        "region_type": "서울",
        ...
        "tag": "유품정리",
        "place": "아파트",
        "title": "서초구 아파트 유품정리 작업후기",
        "summary": "서초구 아파트에서 고인 유품을 분류하고 보관품과 정리품을 구분해 진행한 유품정리입니다.",
        "keywords": "서초구 유품정리, 서초구 아파트 유품정리, 서울 유품정리 작업후기",
        "details": [
            "서초구 반포·방배 인근 아파트 유품정리 현장이었습니다. 고급 주거 비중이 높아 관리실 협의와 조용한 작업 동선을 먼저 맞춘 뒤 유품 확인 범위를 정했습니다.",
            "사진, 서류, 귀중품은 별도로 모아 보관했고, 의류·생활용품은 남길 것과 정리할 것을 구분해 방 단위로 유품정리를 진행했습니다.",
            "폐기물은 종류별로 나눠 반출했고, 작업 후 거실과 방을 비운 상태를 가족분과 함께 확인했습니다. 서초구 유품정리는 보관품 분류를 얼마나 신중히 하느냐가 이후 정리 속도를 좌우했습니다.",
        ],
    },
    {
        "region_type": "서울",
        ...
        "tag": "유품정리",
        "place": "오피스텔",
        "title": "마포구 오피스텔 유품정리 작업후기",
        "summary": "마포구 오피스텔에서 유품 확인부터 공간 정리, 폐기물 반출까지 단계적으로 진행한 유품정리입니다.",
        "keywords": "마포구 유품정리, 마포구 오피스텔 유품정리, 서울 유품정리 작업후기",
        "details": [
            "마포구 합정·공덕 인근 오피스텔 유품정리 상담이었습니다. 원룸형 구조라 공간이 좁아 작업 순서와 반출 동선을 미리 나눴습니다.",
            "침대 주변 서류와 옷장 유품부터 확인해 남길 물건을 먼저 가렸습니다. 가족분이 요청하신 전자기기와 서류함은 별도 포장해 전달했습니다.",
            "남은 생활용품과 소형 가구를 정리·반출한 뒤 바닥이 드러난 상태를 함께 확인했습니다. 마포구 유품정리는 좁은 공간에서도 보관품 분류를 먼저 끝내는 것이 중요했습니다.",
        ],
    },
    {
        "region_type": "경기",
        ...
        "tag": "유품정리",
        "place": "아파트",
        "title": "성남시 아파트 유품정리 작업후기",
        "summary": "성남시 분당권 아파트에서 유품 분류와 공간 정리를 신중하게 진행한 유품정리 작업후기입니다.",
        "keywords": "성남시 유품정리, 성남시 아파트 유품정리, 경기 유품정리 작업후기",
        "details": [
            "성남시 분당구 아파트 유품정리 현장이었습니다. 분당·수정·중원 생활권이 달라 단지마다 반출 규정이 달라, 작업 전 관리실에 가능 시간을 확인했습니다.",
            "안방의 서류와 사진부터 시작해 작은방 의류, 거실 생활용품 순으로 유품정리를 진행했습니다. 가족분이 남기고 싶은 물건을 먼저 고르신 뒤 나머지 물품을 정리·반출로 나눴습니다.",
            "창고와 베란다 물품까지 포함해 공간을 비웠고, 마무리 전 각 방을 다시 확인했습니다. 성남시 유품정리는 아파트형 현장에서 보관품 확인을 얼마나 빨리 마치는지가 핵심이었습니다.",
        ],
    },
    {
        "region_type": "경기",
        "name": "남양주시",
        "slug": "namyangju",
        "path": "namyangju/yupum",
        "tag": "유품정리",
        "place": "빌라",
        "title": "남양주시 빌라 유품정리 작업후기",
        "summary": "남양주시 빌라에서 유품 분류와 공간 정리, 폐기물 반출을 함께 진행한 유품정리 작업후기입니다.",
        "keywords": "남양주시 유품정리, 남양주시 빌라 유품정리, 경기 유품정리 작업후기",
        "details": [
            "남양주시 화도·진접 인근 빌라 유품정리 현장이었습니다. 엘리베이터 없는 구조라 계단 반출과 골목 주차부터 계획을 세웠습니다.",
            "거실과 방의 유품을 사진·서류·생활용품으로 나눠 정리했습니다. 가족분이 남기실 상자류는 열어보지 않고 그대로 옮겨 드렸습니다.",
            "큰 가구는 분해 후 내렸고, 남은 생활폐기물은 분류해 반출했습니다. 남양주시 유품정리는 빌라형 현장에서 반출 동선을 먼저 잡는 것이 안전하고 빨랐습니다.",
        ],
    },
]
